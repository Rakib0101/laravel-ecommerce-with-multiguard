        ...
        <div class="col-md-12">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <a href="{{route('admin.sub_category.create')}}" class="btn btn-primary" style="float:right;">Add New
                        Sub Category</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                                ...
                                <tr>
                                    ...
                                    <td style="display:flex;">
                                        ...
                                        <a class="mr-2 btn btn-primary"
                                            href="{{ route('admin.sub_category.edit', $category->id) }}"><i
                                                class="fa fa-edit"></i></a>
                                        <form action="{{ route('admin.sub_category.destroy', $category->id) }}" class="mr-1"
                                            method="POST">
                                            @method('DELETE')
                                            @csrf
