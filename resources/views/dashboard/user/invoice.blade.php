            ...
            <tr>
                <td>
                    <p class="font" style="margin-left: 20px;">
                        ...
                        <strong>Address:</strong> {{ $order->division->division_name }},
                        {{ $order->district->district_name }}, {{ $order->state->state_name }} <br>
                        <strong>Post Code:</strong> {{ $order->post_code }}
                    </p>
                </td>
                <td>
                    <p class="font">
                        <h3><span style="color: green;">Invoice:</span> #{{ $order->invoice_name }}</h3>
