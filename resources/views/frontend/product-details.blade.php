                                ...
                                <div id="owl-single-product">
                                    <div class="single-product-gallery-item" id="slide1">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            ...
                                            <img class="img-responsive" alt="" src="{{asset($product->product_thambnail)}}"
                                                data-echo="{{asset($product->product_thambnail)}}" />
                                        </a>
                                    </div><!-- /.single-product-gallery-item -->
                                    @foreach ($product->product_galleries as $gallery)                                       
  
                                    <div class="single-product-gallery-item" id="{{'slide'.$gallery->id}}">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            href="{{asset($gallery->photo_name)}}">
                                            <img class="img-responsive" alt="" src="{{asset($gallery->photo_name)}}"
                                                data-echo="{{asset($gallery->photo_name)}}" />
                                        </a>
                                    </div><!-- /.single-product-gallery-item -->                                    
                                    @endforeach
                            ...
                            <div class="product-info">
                                ...
                                <div class="price-container info-container m-t-20">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="price-box">
                                                <span class="price">${{$product->selling_price == null ? $product->regular_price : $product->selling_price}}</span>
                                                <span class="price-strike">{{$product->selling_price !== null ? '$'.$product->regular_price : ''}}</span>
                                            </div>
                                        </div>
                                ...
                                <div class="quantity-container info-container">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" id="{{ $product->id }}" onclick="productView(this.id)"><i
